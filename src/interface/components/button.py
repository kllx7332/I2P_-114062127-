...
def main():
    ...
    while running:
        ...
        if overlay_active:
            ...
            overlay_surface = pg.Surface((WIDTH, HEIGHT))
            overlay_surface.set_alpha(128)  
            overlay_surface.fill((0, 0, 0))
            screen.blit(overlay_surface, (0, 0))

            # Draw overlay and back button
            overlay_rect = pg.Rect(WIDTH // 2 - 150, HEIGHT // 2 - 100, 300, 200)
            pg.draw.rect(screen, (50, 50, 50), overlay_rect)  
